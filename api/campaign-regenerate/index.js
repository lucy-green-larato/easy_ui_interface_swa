// Proxy to Python POST /api/campaign/regenerate
...
module.exports = async function (context, req) {
  try {
    ...
    const url  = `${base}/api/campaign/regenerate`;
    ...
    context.log.error("campaign-regenerate proxy error", e);
    context.res = { status: 502, headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ error: "regenerate_proxy_exception", detail: String(e?.message || e) }) };
  }
};
